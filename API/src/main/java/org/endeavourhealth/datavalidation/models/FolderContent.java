...
public final class FolderContent implements Comparable {
    ...
    public FolderContent(ActiveItem activeItem, Item item, Audit audit) {
        this(item, audit);
        setTypeEnum(DefinitionItemType.get(activeItem.getItemTypeId()));
    }

    public FolderContent(Item item, Audit audit) {
    ...
    public int compareTo(Object o) {
        FolderContent other = (FolderContent)o;
